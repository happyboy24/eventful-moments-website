  ...
  <footer className="bg-primary text-primary-foreground py-16">
    <div className="container grid md:grid-cols-3 gap-10">
      <div>
        ...
        <p className="text-primary-foreground/70 leading-relaxed">Making every moment unforgettable through elegant, thoughtful event planning.</p>
      </div>
      <div>
        ...
        <ul className="space-y-3 text-primary-foreground/80">
          ...
          <li className="flex items-center gap-3"><Mail className="size-4 text-accent" /> hello@tripletevents.com</li>
